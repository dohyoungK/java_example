...
public class Implementation_BinarySearchTree_08 {
    public static void main(String[] args) {
        Implementation_BinarySearchTree_08.binarySearchTree tree = new Implementation_BinarySearchTree_08.binarySearchTree();
        tree.root = new Implementation_BinarySearchTree_08.Node(10);
        tree.insert(7);
        tree.insert(8);
        tree.insert(12);
        tree.insert(11);
        ...
        System.out.println(tree.preorderTree(tree.root, 0, new ArrayList<Integer>()).toString());
    }
