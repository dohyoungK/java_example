...
public class Implementation_Graph_AdjacencyList_09 {
    public static void main(String[] args) {
        Implementation_Graph_AdjacencyList_09 adjList = new Implementation_Graph_AdjacencyList_09();
        adjList.setGraph(3);
    ...
    public Implementation_Graph_AdjacencyList_09() {
        graph = new ArrayList<>();
    }
